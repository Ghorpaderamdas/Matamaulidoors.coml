...
//     <section
//       id="home"
//       className="relative isolate flex min-h-screen overflow-hidden bg-[#0a0a0a] text-[#FFFFFF]"
//     >
//       <style>{`
...
//         <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(200,155,60,0.08),transparent_60%)]" />
//         <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(0,0,0,0.25)_0%,rgba(0,0,0,0.05)_48%,rgba(0,0,0,0.25)_100%)]" />

//         {/* Navigation Arrows */}
//         <button
//           onClick={goToPreviousImage}
//           className="slide-control absolute left-4 top-1/2 z-20 -translate-y-1/2 rounded-full bg-black/30 p-3 text-white backdrop-blur-sm transition-all duration-300 hover:bg-black/50 hover:scale-110"
...
//           className="slide-control absolute right-4 top-1/2 z-20 -translate-y-1/2 rounded-full bg-black/30 p-3 text-white backdrop-blur-sm transition-all duration-300 hover:bg-black/50 hover:scale-110"
...
//       {/* Decorative Elements */}
//       <div className="absolute top-20 right-20 -z-10 h-64 w-64 rounded-full bg-[#C89B3C] opacity-[0.08] blur-3xl" />
//       <div className="absolute bottom-20 left-20 -z-10 h-96 w-96 rounded-full bg-[#C89B3C] opacity-[0.08] blur-3xl" />
//       <div className="absolute top-1/2 left-1/2 -z-10 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#C89B3C] opacity-[0.03] blur-3xl" />
...
//         {/* Badge */}
//         <div className="animate-[heroFadeUp_800ms_ease-out_both] rounded-full border border-[#C89B3C]/30 bg-[#1a120b]/60 px-6 py-2.5 text-xs font-medium uppercase tracking-[0.28em] text-[#E7C77A] shadow-[0_18px_50px_rgba(0,0,0,0.15)] backdrop-blur-md hover:border-[#C89B3C]/50 transition-all duration-300 sm:px-7 sm:text-xs">
//           <span className="mr-2 inline-block h-2.5 w-2.5 rounded-full bg-[#C89B3C] align-middle shadow-[0_0_18px_rgba(200,155,60,0.5)] animate-pulse" />
...
//               className={
//                 action.primary
//                   ? "group hover-lift inline-flex min-h-[56px] w-full items-center justify-center gap-3 rounded-full bg-[#C89B3C] px-10 font-sans text-base font-semibold text-[#111111] transition-all duration-300 hover:bg-[#B68A2D] hover:shadow-[0_22px_42px_rgba(200,155,60,0.4)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#C89B3C]/40 sm:w-auto sm:min-w-[220px]"
//                   : "group hover-lift inline-flex min-h-[56px] w-full items-center justify-center rounded-full border border-white/40 bg-white/5 backdrop-blur-sm px-10 font-sans text-base font-semibold text-white transition-all duration-300 hover:bg-white/20 hover:border-white/60 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/30 sm:w-auto sm:min-w-[220px]"
//               }
//             >
//               {action.label}
//               {action.primary ? (
...
//               <div
//                 key={index}
//                 className="group hover-lift rounded-2xl glass-effect p-3.5 text-center transition-all duration-300 hover:border-[#C89B3C]/30 hover:shadow-[0_8px_32px_rgba(200,155,60,0.15)]"
//               >
//                 <div className="mb-2 flex justify-center">
//                   <div className="rounded-full bg-[#C89B3C]/10 p-2 transition-all duration-300 group-hover:bg-[#C89B3C]/25 group-hover:scale-110">
...
//                 <p className="mt-0.5 text-[10px] text-white/50 transition-colors duration-300 group-hover:text-white/70 sm:text-xs">{feature.description}</p>
//               </div>
//             );
//           })}
//         </div>
...
//         <a
//           href="#about"
//           className="group mt-12 inline-flex min-h-11 animate-[heroFadeUp_900ms_ease-out_700ms_both] flex-col items-center gap-2 font-serif text-xs uppercase tracking-[0.28em] text-white/70 transition-all duration-300 hover:text-[#C89B3C] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/20"
...
//           </span>
//           <ChevronDown
//             className="animate-bounce text-white/70 transition-all duration-300 group-hover:text-[#C89B3C] group-hover:scale-110"
//             size={24}
//             strokeWidth={1.6}
//             aria-hidden="true"
//           />
