...
export default function NotFound() {
  return (
    <main id="main-content" tabIndex={-1} className="flex min-h-screen flex-col items-center justify-center gap-6 overflow-x-hidden bg-[#F9F7F3] px-4 text-center text-[#1B1B1B] sm:px-6 lg:px-8">
